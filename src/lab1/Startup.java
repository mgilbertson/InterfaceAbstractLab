...
public class Startup {
    ...
    public static void main(String[] args) {
        ProgrammingCourse advJava1 = new AdvancedJavaCourse();
        ...
        System.out.println("");
        ProgrammingCourse intJava1 = new IntroJavaCourse();
        ...
        System.out.println("");
        ProgrammingCourse intProg1 = new IntroToProgrammingCourse();
